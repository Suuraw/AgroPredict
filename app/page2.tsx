...
export default function Component() {
  return (
    <>
      ...
      <TextComponent content="Farmers enter soil parameters like nitrogen, pH, phosphorous, and potassium to analyze crop health." textAlign="left" />
      
      <TitleComponent title="Soil Parameters" size="lg" textAlign="left" />
      
      <FormInputComponent title="Nitrogen (N)" placeholder="Enter nitrogen level (ppm)" />
      <FormInputComponent title="pH" placeholder="Enter soil pH level" />
      <FormInputComponent title="Phosphorous (P)" placeholder="Enter phosphorous level (ppm)" />
      <FormInputComponent title="Potassium (K)" placeholder="Enter potassium level (ppm)" />
