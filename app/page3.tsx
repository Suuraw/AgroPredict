  ...
  return (
    <>
      <div className="h-screen">
        ...
        <TextComponent
          content="Based on soil type and crop type, users receive tailored fertilizer suggestions."
          textAlign="center"
        />

        <SegmentedControl data={["Soil Composition"]} />
        ...
        />
        <FormInputComponent
          title="Enter Nitrogen Content"
          placeholder="e.g. 4tonnes ,550ppm"
        />
        <FormInputComponent
          title="Enter Potassium Content"
          placeholder="e.g. 4tonnes ,550ppm"
        />
        <FormInputComponent
          title="Enter Phosphorus Content"
          placeholder="e.g. 4tonnes ,550ppm"
        />
